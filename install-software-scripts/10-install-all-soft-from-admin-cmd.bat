...
winget install --id Adobe.Acrobat.Reader.64-bit --silent --accept-package-agreements --accept-source-agreements --uninstall-previous
winget install Irfanview64 --silent --accept-package-agreements --accept-source-agreements --uninstall-previous --source winget
winget install KeePassXC --silent --accept-package-agreements --accept-source-agreements --uninstall-previous --source winget
winget install paint.net --silent --accept-package-agreements --accept-source-agreements --uninstall-previous
winget install --id VideoLAN.VLC --silent --accept-package-agreements --accept-source-agreements --uninstall-previous
